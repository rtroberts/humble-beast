...
lampwick.controller('mediaListCtrl', function($scope, $cookies, $window, $http, $sce, $timeout) {
  ...
  $scope.share = {
    ...
    twitter: function() {
      ...
      var tScreen = 'screen_name=SLBible';
    ...
    youtube: function() {
      var uri = 'https://www.youtube.com/channel/UCCHRlahR6yaGbanFSsUg_Ew';
  ...
  $scope.medias = [{
      'name': "instagram",
      'heading': "Follow @streetlightsbible on Instagram",
      'content': '',
      'button': $scope.share.instagram,
      'buttonHTML': $scope.createButtonHTML('instagram', 'Follow @streetlightsbible'),
    ...
    {
      'name': "facebook",
      'heading': "Visit Streetlights on Facebook",
      'content': '',
      'button': $scope.share.facebook,
      'buttonHTML': $scope.createButtonHTML('facebook', 'Visit Streetlights'),
    ...
    {
      'name': "twitter",
      'heading': "Follow @SLBible on Twitter",
      'content': '',
      'button': $scope.share.twitter,
      'buttonHTML': $scope.createButtonHTML('twitter', 'Follow @SLBible'),
...

    {
      ...
      'buttonHTML': '<div class = "media-button"> <a class = "btn btn-block btn-social btn-google"> <span class = "fa fa-youtube"> </span> Subscribe to Streetlights Video </a> </div>',
    ...
    // {
    //  'name': "superphone",
    //  'heading': "Sign up for Text alerts",
    //  'content': 'some html/js string?',
    //  'description': 'If you give us your phone number, we won\'t abuse it.',
    //  'button': '',
    //  'isFollowing': $scope.isFollowing('superphone'),
    //'isLoading': false,
    //}
  ];
